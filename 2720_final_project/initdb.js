...
function populateData() {
  ...
  var items = [
    _item(0,'Apple', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. ' +
      ...
      _item(3,'Apple3', 'Apple Des', 'images/sample.jpg',8,1, new Date(2016, 11, 11),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(0,'Apple4', 'Apple Des', 'images/sample.jpg',23,1, new Date(2016, 11, 12),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(2,'Apple5', 'Apple Des', 'images/sample.jpg',45,1, new Date(2016, 11, 13),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(4,'Apple6', 'Apple Des', 'images/sample.jpg',23,1, new Date(2016, 11, 14),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(0,'Apple', 'Apple Des', 'images/sample.jpg',5,1, new Date(2016, 11, 15),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(1,'Apple11', 'Apple Des', 'images/sample.jpg',5,1, new Date(2016, 11, 16),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(2,'Apple2', 'Apple Des', 'images/sample.jpg',5,1, new Date(2016, 11, 17),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(3,'Apple3', 'Apple Des', 'images/sample.jpg',5,1, new Date(2016, 11, 18),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(0,'Apple4', 'Apple Des', 'images/sample.jpg',5,1, new Date(2016, 11, 19),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(2,'Apple5', 'Apple Des', 'images/sample.jpg',5,1, new Date(2016, 11, 20),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]]),
      _item(4,'Apple6', 'Apple Des', 'images/sample.jpg',5,1, new Date(2016, 11, 21),new Date(2016, 11, 11), [t[0], t[1], t[3], t[4]])
